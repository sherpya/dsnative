...
CRenderPin::CRenderPin(HRESULT *phr, CRenderFilter *pFilter, CCritSec *pLock) : m_gPtr(NULL), m_reftime(-1LL << 63), m_fSize(0), CBaseInputPin(NAME("CRenderPin"), pFilter, pLock, phr, L"Render")
{
}
